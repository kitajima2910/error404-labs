...
return {
	...
	_: {
		...
		routes: [
			{
				id: "/api/bai-dang",
				pattern: /^\/api\/bai-dang\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/bai-dang/_server.ts.js'))
			},
			{
				id: "/api/github-avatar/u/[userid]",
				pattern: /^\/api\/github-avatar\/u\/([^/]+?)\/?$/,
				params: [{"name":"userid","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/github-avatar/u/_userid_/_server.ts.js'))
			},
			{
				id: "/api/github-profile/[username]",
				pattern: /^\/api\/github-profile\/([^/]+?)\/?$/,
				params: [{"name":"username","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/github-profile/_username_/_server.ts.js'))
			}
		],
		prerendered_routes: new Set(["/","/__data.json","/gioi-thieu","/huong-dan-hoc","/huong-dan-hoc/codeptit-c","/huong-dan-hoc/lap-trinh-c-cpp","/huong-dan-hoc/lap-trinh-c-cpp/oj.isp88.win","/huong-dan-hoc/lap-trinh-c-cpp/tu-co-ban-den-nang-cao","/huong-dan-hoc/lap-trinh-web","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare","/huong-dan-hoc/lap-trinh-web/tao-trang-web-tap-chi-dien-tu","/lien-he","/rss.xml","/tro-choi","/ve-toi","/ve-toi/__data.json","/bai-dang-2","/bai-dang-1","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/01","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/01/__data.json","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/02","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/02/__data.json","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/03","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/03/__data.json","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/04","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/04/__data.json","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/05","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/05/__data.json","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/06","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/06/__data.json","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/07","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/07/__data.json","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/08","/huong-dan-hoc/lap-trinh-web/khoa-hoc-slideshare/08/__data.json"]),
		matchers: async () => {
