export const categories = [
...

    {
        ...
        color: 'bg-[#7C3AED]',
        items: [
            { id: 'roadmap_m1_w1', text: 'Quyền xem AI Velocity Sprint' },
            { id: 'roadmap_m1_w2', text: 'Quyền xem Quantum Block Shift' },
            { id: 'roadmap_m1_w3', text: 'Quyền xem Spatial Dodge Zone' },
            { id: 'roadmap_m1_w4', text: 'Quyền xem Meta Farm Builder' },
            { id: 'roadmap_m2_w1', text: 'Quyền xem AI Flappy Neural' },
            { id: 'roadmap_m2_w2', text: 'Quyền xem AI Velocity Sprint' },
            { id: 'roadmap_m2_w3', text: 'Quyền xem Cyber Geo Dash' },
            { id: 'roadmap_m2_w4', text: 'Quyền xem Meta Helix Drop' },
            { id: 'roadmap_m3_w1', text: 'Quyền xem AI Slime Blaster' },
            { id: 'roadmap_m3_w2', text: 'Quyền xem Spatial Pop Blast' },
            { id: 'roadmap_m3_w3', text: 'Quyền xem Meta Arsenal Run' },
            { id: 'roadmap_m3_w4', text: 'Quyền xem Cyber Slash Dash' },
            { id: 'roadmap_m4_w1', text: 'Quyền xem Neural Mosaic Quest' },
            { id: 'roadmap_m4_w2', text: 'Quyền xem AI Sort Factory' },
            { id: 'roadmap_m4_w3', text: 'Quyền xem Spatial Crate Push' },
            { id: 'roadmap_m4_w4', text: 'Quyền xem Meta Hoop Shot' },
        ],
    },
    {
        ...
        color: 'bg-[#7C3AED]',
        items: [
            { id: 'roadmap_m5_w1', text: 'Quyền xem AI Combo Rookie' },
            { id: 'roadmap_m5_w2', text: 'Quyền xem AI Slime King' },
            { id: 'roadmap_m5_w3', text: 'Quyền xem AI Jump Strike' },
            { id: 'roadmap_m5_w4', text: 'Quyền xem AI Survival Ring' },
            { id: 'roadmap_m6_w1', text: 'Quyền xem AI Beat Reactor' },
            { id: 'roadmap_m6_w2', text: 'Quyền xem AI Piano Rush' },
            { id: 'roadmap_m6_w3', text: 'Quyền xem AI Beat Dodge' },
            { id: 'roadmap_m6_w4', text: 'Quyền xem AI Dance Floor' },
            { id: 'roadmap_m7_w1', text: 'Quyền xem AI Coin Magnet' },
            { id: 'roadmap_m7_w2', text: 'Quyền xem AI Crystal Cave' },
            { id: 'roadmap_m7_w3', text: 'Quyền xem AI Fruit Frenzy' },
            { id: 'roadmap_m7_w4', text: 'Quyền xem AI Farm Loop' },
            { id: 'roadmap_m8_w1', text: 'Quyền xem AI Blast Sandbox' },
            { id: 'roadmap_m8_w2', text: 'Quyền xem AI Flame Forge' },
            { id: 'roadmap_m8_w3', text: 'Quyền xem AI Heal Pulse' },
            { id: 'roadmap_m8_w4', text: 'Quyền xem AI Dash Runner' },
        ],
    },
    {
        ...
        color: 'bg-[#7C3AED]',
        items: [
            { id: 'roadmap_m9_w1', text: 'Quyền xem AI Core Upgrade' },
            { id: 'roadmap_m9_w2', text: 'Quyền xem AI Weapon Shop' },
            { id: 'roadmap_m9_w3', text: 'Quyền xem AI XP Climb' },
            { id: 'roadmap_m9_w4', text: 'Quyền xem AI Quest Signal' },
            { id: 'roadmap_m10_w1', text: 'Quyền xem AI Patrol Bot' },
            { id: 'roadmap_m10_w2', text: 'Quyền xem AI Spiral Duel' },
            { id: 'roadmap_m10_w3', text: 'Quyền xem AI Boss Protocol' },
            { id: 'roadmap_m10_w4', text: 'Quyền xem AI NPC Village' },
            { id: 'roadmap_m11_w1', text: 'Quyền xem AI Platformer Lab' },
            { id: 'roadmap_m11_w2', text: 'Quyền xem AI Forest Run' },
            { id: 'roadmap_m11_w3', text: 'Quyền xem AI Game Spark' },
            { id: 'roadmap_m11_w4', text: 'Quyền xem AI Mechanic Fusion' },
            { id: 'roadmap_m12_w1', text: 'Quyền xem AI Menu Command' },
            { id: 'roadmap_m12_w2', text: 'Quyền xem AI Sound Studio' },
            { id: 'roadmap_m12_w3', text: 'Quyền xem AI QA Arena' },
            { id: 'roadmap_m12_w4', text: 'Quyền xem AI Trailer Cut' },
        ],
    },
]
