...
const ExpenseForm = ({ selectedExpense, saveInputHandler, formInvalidFromParent }) => {
    ...
    return (
        <View style={[styles.form, { flex: 1 / 2.5 }]}>
            <Text style={styles.title}>Your Expense</Text>
            <View style={styles.inputsRow}>
                <Input invalid={invalidChild.amount} style={styles.rowInput} label="Amount" textInputConfig={{
                    keyboardType: "decimal-pad",
                    onChangeText: (newValue) => inputChangeHandler("amount", newValue),
                    value: inputValue.amount
                }} />
                <Input invalid={invalidChild.date} style={styles.rowInput} label="Date" textInputConfig={{
            ...
            <Input invalid={invalidChild.description} style={[styles.rowInput, { marginBottom: 8 }]} label="Description" textInputConfig={{
                multiline: true,
